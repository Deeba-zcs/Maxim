  ...
  const persons = [
    ...
    },
    {
      lines:
        " Export tempor illum tamen malis malis eram quae irure esse labore quem cillum quid cillum eram malis quorum velit fore eram velit sunt aliqua noster fugiat irure amet legam anim culpa.",
      imgsrc:
        "https://bootstrapmade.com/demo/templates/Maxim/assets/img/testimonials/testimonials-2.jpg",
      name: "Sara Wilsson",
      post: "Designer",
    },
    {
                    ...
                    <SwiperSlide className="">
                      <div className="my-4 mb-5">
                        <div className="card rounded border-0">
                          <div
                            className={`card-body  rounded ${Style.cardtext}`}
                          >
                          ...
                          <h6 className={` ms-4 pt-0 ${Style.namecolor}`}>
                            {d.post}
                          </h6>
                        </div>
                      </div>
